...
fn managed_cli_readiness_counts_are_explicit() {
    ...
    assert_eq!(count_by(&cli_rows, |row| row.status, "partial"), 20);
    assert_eq!(count_by(&cli_rows, |row| row.status, "missing"), 2);
    ...
    assert_eq!(count_by(&cli_rows, |row| row.oracle_level, "unit"), 15);
    assert_eq!(
...
fn managed_workstream_readiness_counts_are_explicit() {
    ...
    assert_eq!(count_by(&rows, |row| row.status, "partial"), 20);
    assert_eq!(count_by(&rows, |row| row.status, "missing"), 9);
    ...
    assert_eq!(count_by(&rows, |row| row.oracle_level, "unit"), 15);
    assert_eq!(count_by(&rows, |row| row.oracle_level, "needs_fixture"), 10);
}
